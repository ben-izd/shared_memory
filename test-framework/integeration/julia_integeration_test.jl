...
data_path = joinpath(@__DIR__,"integeration_test_data")
...
#     open(raw"D:\projects\Mathematica\community\31. shared_memory\test-framework\integeration\log.txt", "a") do io
#         write(io, text*"\n")
#     end;
# end
